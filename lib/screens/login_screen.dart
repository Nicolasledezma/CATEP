...
//validar API ESTO LO ARMÉ CON CLOUDE
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Inicia sesion para acceder a tus actividades',
                            style: TextStyle(
                              fontSize: 15,
  ...
  Widget _buildLogo({double size = 60, String imagePath = 'img/logo_catep.jpg'}) {
    return Container(
      width: size * 2.2, // Un poco más ancho para que se vea bien
      height: size,
      child: Image.asset(
        imagePath,
        fit: BoxFit.contain,
          ...
          Align(
            ...
            child: TextButton(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: isDark ? Colors.white70 : const Color(0xFF4A90D9),
                  fontSize: 13,
